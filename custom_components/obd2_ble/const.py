...
DEFAULT_COMMANDS = [
    {CONF_COMMAND: "ENGINE_SPEED"},
    {CONF_COMMAND: "VEHICLE_SPEED"},
    {CONF_COMMAND: "ENGINE_COOLANT_TEMP"},
    {CONF_COMMAND: "INTAKE_AIR_TEMP"},
    {CONF_COMMAND: "VEHICLE_VOLTAGE"},
    {CONF_COMMAND: "FUEL_LEVEL"},
    {CONF_COMMAND: "ENGINE_LOAD"},
    {CONF_COMMAND: "THROTTLE_POSITION"},
    {CONF_COMMAND: "ENGINE_RUN_TIME"},
    {CONF_COMMAND: "MAF_RATE"},
    {CONF_COMMAND: "INTAKE_PRESSURE"},
    {CONF_COMMAND: "HONDA_ATF_TEMP_8220"},
    {CONF_COMMAND: "HONDA_ATF_TEMP_9023"},
]
